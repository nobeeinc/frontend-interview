    ...
    <div className="">
      <div className="mx-5 mt-6">
        <div className="flex justify-between">
          <h5 className="font-proxima font-semibold text-2xl mb-4">
            Sign up or Login
          </h5>
          <div
            onClick={() => {
        ...
        <Formik
          ...
          onSubmit={(values: Values) => {
            axios
              .head(`http://localhost:3000/api/auth/emails/${values.email}`)
              .then((res) => {
        ...
        >
          <Form>
            <label
              className="font-sans text-gray-700 font-semibold text-sm leading-3"
              htmlFor="email"
            >
              Your email
            </label>
            ...
            <br />
            <button
              className="flex items-center text-white justify-center rounded-lg bg-primary mt-2 w-full h-12"
              type="submit"
            >
              Continue
            </button>
