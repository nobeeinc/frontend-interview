...
export const LoginComponent = () => {
  ...
  return (
    <>
      ...
      <div className="pt-14">
        {isError && (
          <div className="px-5 py-3 bg-error text-xs text-danger space-y-1">
        ...
        <div className="px-5">
          <form onSubmit={formik.handleSubmit}>
            <div className="flex flex-col mt-4">
              <label
                htmlFor="email"
                className="font-sans text-xs text-gray-700 font-bold mb-1"
              >
                Your email
              </label>
              <input
            ...
            <p className="mt-2 text-sm">
              <Link href="/register">
                <a className="font-bold underline">Sign up</a>
              </Link>
            </p>
          </form>
        </div>
