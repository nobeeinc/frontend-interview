  ...
  return ((
    <div className={style.body}>
      ...
      {(validEmail != 0 || validPassword != 0) && <div className={style.errorMessage}>
        ...
        {(validPassword == 3) && <div className={style.message}>The password you entered incorrect, please try again!</div>}
      </div>}
      ...
      <a href='http://localhost:3000/signup' className={style.linkStyle}>Sign up?</a>
