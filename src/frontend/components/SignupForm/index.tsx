    ...
    <div className={style.body}>
      ...
      {(validEmail != 0 || validPassword != 0) && (
        <div className={style.errorMessage}>
          ...
          {validPassword == 2 && (
            <div className={style.message}>Invalid password!</div>
          )}
          {validPassword == 3 && (
            <div className={style.message}>Password does not match</div>
          )}
        </div>
      )}
      ...
      <div style={{ marginTop: '18px' }}>
        ...
        <a href="http://localhost:3000/login" className={style.linkStyle}>
          Login
        </a>
      </div>
    </div>
